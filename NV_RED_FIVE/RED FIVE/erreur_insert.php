...
<html lang="en">
  ...
  <body class="bg-image text-white" 
     ...
     <div class="position-absolute top-50 start-50 translate-middle">
         <h1 class="text-center">Oups il semblerait qu'il y ait une erreur dans votre réservation réessayer !!!</h1>
         <center><div class="vw-10"><img src="image/erreur.png" alt=""></div></center>
    </div>   
